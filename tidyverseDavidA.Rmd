...
Based on David's example, I added a bar plot to demonstrate the average rent ranking from the highest to the lowest across the states. 

```{r}
ggplot(avg.rent.bystate, aes(x=reorder(State_Name, -AvgRent), y=AvgRent)) + 
